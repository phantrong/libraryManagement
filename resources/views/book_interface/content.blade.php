<div id="content" class="content section container">
    <div class="breadcrumb">
        ...
        <a class="breadcrumb-item" href="/">Sách kỹ năng</a>
        <a class="breadcrumb-item" href="/">A short history of everything</a>
    </div>
    <div class="single-book row" >
        ...
        <div class="book-main col-xl-8 col-lg-8">
            <h2 class="book-heading">A short history of everything</h2>
            <h3 class="book-author">Tác giả: Phan Đức Trung</h3>
            <div class="book-info">
                <table>
                    <tbody>
                        <tr>
