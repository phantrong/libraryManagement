...
/***/ "./resources/js/admin/book_interface/cart.js":
/*!***************************************************!*\
  !*** ./resources/js/admin/book_interface/cart.js ***!
  \***************************************************/
/*! no static exports found */
...
$(document).ready(function () {
  ...
  var arrNum = $('.cart-num');
  var listItemBig = $('.row-cart');
  var listItemSmall = $('.nav-cart-item');
  listItemBig.each(function (index, cur) {
    $(this).find('> * > * >.btn-add').click(function () {
      var bookQuantity = Number($(this).find("#book_quantity").val());
      ...
      if (arrNum[index].value > bookQuantity) {
        ...
        axios.post('/user/changecart', data).then(function (res) {
          if (res.data.success) {
    ...
    $(this).find('> * > .btn-remove').click(function () {
      ...
      axios.post('/user/deletecart', data).then(function (res) {
        if (res.data.success) {
          $('.cart-interface .cart-info #sum-book').text(res.data.sumBook);
          $('.nav-logged-in .nav-cart-notice').text(res.data.countCast);
        }
  ...
  $('.cart-interface .checkbox-address').on('change', function () {
    checkboxAddress++;
    var val = $(".cart-interface input[name='address-default']").val();
  ...
  var checkDate = function checkDate() {
    var today = new Date();
    var giveback = new Date($('.date-giveback').val());
...
/***/ "./resources/js/admin/welcome/index.js":
/*!*********************************************!*\
  !*** ./resources/js/admin/welcome/index.js ***!
  \*********************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./slider */ "./resources/js/admin/welcome/slider.js");

__webpack_require__(/*! ./scroll_smooth */ "./resources/js/admin/welcome/scroll_smooth.js");

__webpack_require__(/*! ../book_interface/cart */ "./resources/js/admin/book_interface/cart.js");
...
window.addEventListener('scroll', function () {
  var sections = document.querySelectorAll('.sec-act');
...
/***/ "./resources/js/admin/welcome/scroll_smooth.js":
/*!*****************************************************!*\
  !*** ./resources/js/admin/welcome/scroll_smooth.js ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./resources/js/admin/welcome/slider.js":
/*!**********************************************!*\
  !*** ./resources/js/admin/welcome/slider.js ***!
  \**********************************************/
/*! no static exports found */
...
var slider = {
  ...
  loadCurSlide: function loadCurSlide() {
...
/***/ 9:
/*!***************************************************!*\
  !*** multi ./resources/js/admin/welcome/index.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
