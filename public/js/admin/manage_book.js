...
/***/ "./resources/js/admin/manage_book/create.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/manage_book/create.js ***!
  \**************************************************/
/*! no static exports found */
...
$(function () {
  ...
  var a = document.querySelector('.navbar1');

  a.children[0].onclick = function (e) {
    var b = document.querySelector('.book').getAttribute('class');
    console.log(b);

    if (b.split(' ')[2] == undefined) {
      document.querySelector('.book').setAttribute('class', "".concat(b, " activeWidth"));
    } else {
...
/***/ "./resources/js/admin/manage_book/edit.js":
/*!************************************************!*\
  !*** ./resources/js/admin/manage_book/edit.js ***!
  \************************************************/
/*! no static exports found */
...
$(function () {
  ...
  $("#form-edit-book .btn-delete-book").on('click', function () {
    var id = $("#form-edit-book input[name='book_id']").val();
    axios["delete"]("/admin/book/".concat(id)).then(function () {
...
/***/ "./resources/js/admin/manage_book/index.js":
/*!*************************************************!*\
  !*** ./resources/js/admin/manage_book/index.js ***!
  \*************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./create */ "./resources/js/admin/manage_book/create.js");

__webpack_require__(/*! ./edit */ "./resources/js/admin/manage_book/edit.js");
...
/***/ 3:
/*!*******************************************************!*\
  !*** multi ./resources/js/admin/manage_book/index.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\XAMPP\htdocs\libraryManagement\resources\js\admin\manage_book\index.js */"./resources/js/admin/manage_book/index.js");
