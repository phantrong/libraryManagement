...
/***/ "./resources/js/admin/manage_order/index.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/manage_order/index.js ***!
  \**************************************************/
/*! no static exports found */
...
$(function () {
  $('#list-order .admin__order-button-edit').on('click', function () {
    ...
    var date = Parent.find("input");
    var saveButton = Parent.find('.admin__order-button-save');
  ...
  $('#list-order .admin__order-button-save').on('click', function () {
    var Parent = $(this).parent().parent().parent();
    var date = Parent.find("input");
    var id = $(this).attr('attr-order');
    var time_borrow = Parent.find("input[name='time_borrow']");
    var time_promise_pay = Parent.find("input[name='time_promise_pay']");
    var time_pay = Parent.find("input[name='time_pay']");
    var editButton = Parent.find('.admin__order-button-edit');
    ...
    axios.post('/admin/order/edit', data).then(function (res) {
  ...
  $('#list-order .background-notBorrow .btn_confirm').on('click', function () {
    ...
    var id = $(this).attr('attr-order');
    var type = 'one-to-three';
    var data = {
      id: id,
      type: type
    };
    axios.post('/admin/order/changestatus', data).then(function (res) {
      if (res.data.success) {
        var parent = $(_this).closest('.admin__order-col');
        var background = parent.closest('.background-notBorrow');
        var statusText = background.find('.col-status');
  ...
  $('#exampleModalCancel .btn-cancel').on('click', function () {
    if (idOrderChoose && btnCancel) {
      var id = idOrderChoose;
      var type = 'cancel';
      var data = {
        id: id,
        type: type
      };
      axios.post('/admin/order/cancel', data).then(function (res) {
        if (res.data.success) {
          var parent = btnCancel.closest('.admin__order-col');
          var background = parent.closest('tr');
          var statusText = background.find('.col-status');
  ...
  $('#list-order #exampleModal .btn-delete').on('click', function () {
    if (idOrderDel && btnDel) {
      ...
      axios.post('/admin/order/delete', data).then(function (res) {
        if (res.data.success == '1') {
  ...
  $('#modal-cancel #submit-cancel').on('click', function () {
    if (idOrderCancel && colOrderCancel) {
      ...
      axios.post('/user/order/cancel', data).then(function (res) {
        if (res.data.success) {
...
$('.header__notify-header #readed').on('click', function () {
  ...
  axios.post('/user/alert/readed', data).then(function (res) {
    if (res.data.success) {
...
/***/ 5:
/*!********************************************************!*\
  !*** multi ./resources/js/admin/manage_order/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\XAMPP\htdocs\libraryManagement\resources\js\admin\manage_order\index.js */"./resources/js/admin/manage_order/index.js");
