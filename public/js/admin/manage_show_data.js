...
/***/ "./resources/js/admin/manage_show_data/index.js":
/*!******************************************************!*\
  !*** ./resources/js/admin/manage_show_data/index.js ***!
  \******************************************************/
/*! no static exports found */
...
$(function () {
  ...
  typeofbooks.change(function () {
    ...
    $.ajax({
      type: 'POST',
      url: '/ajax/search',
      data: _defineProperty({}, $(this).attr('name'), $(this).val()),
  ...
  $('#searchinput').on('keyup', function () {
    ...
    if (dtt.length == 0) {
      ...
      if ($(this).val() == '') document.querySelector('.dashboard-money-content-search-listsearch-list').innerHTML = '<li>type some thing</li>';else {
        ...
        if (rsSearch.length == 0) document.querySelector('.dashboard-money-content-search-listsearch-list').innerHTML = '<li>the result is not exist</li>';else document.querySelector('.dashboard-money-content-search-listsearch-list').innerHTML = Array.from(new Set(rsSearch)).join('');
      }
    }
  ...
  $.ajax({
    ...
    success: function success(res) {
      var nameBook = res.reduce(function (arr, value) {
        return arr.concat(value.nameBook);
      }, []);
      var valueY = res.reduce(function (arr, value) {
        return arr.concat(value.total);
      }, []);
      var ctx1 = document.getElementById('mayChart1');
...
/***/ 6:
/*!************************************************************!*\
  !*** multi ./resources/js/admin/manage_show_data/index.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
