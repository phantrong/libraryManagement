...
/***/ "./resources/js/admin/book_interface/index.js":
/*!****************************************************!*\
  !*** ./resources/js/admin/book_interface/index.js ***!
  \****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ../welcome/scroll_smooth */ "./resources/js/admin/welcome/scroll_smooth.js");

__webpack_require__(/*! ./cart */ "./resources/js/admin/book_interface/cart.js");
...
$(document).ready(function () {
  ...
  var bookQuantity = Number($("input[name='book_quantity']").val());
  ...
  var listImgMax = $('.list-img-max');
  var mainImg = $('.book-main-img img');
  var sliderMainImg = $('.slider-view-main img');
  ...
  $('.next').click(function () {
    var curIndex = listImgMax.index($('.list-img-max.active'));
    listImgMax.removeClass('active');
    curIndex += 1;
...
/***/ 1:
/*!**********************************************************!*\
  !*** multi ./resources/js/admin/book_interface/index.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
